...
def wait_wf_3d_mesh_hl(**context):
    ...
    logger.info(f"mesh_hl_batch_id: {mesh_hl_batch_id}")
    try:
        client = Metashape.NetworkClient()
        client.connect(metashape_server_ip)
        while True:
            batch_info = client.batchInfo(mesh_hl_batch_id)
            ...
            if batch_info['state'] == 'completed':
                ...
                try:
                    ...
                    notify_task_completion(
                        ...
                        task_name="build_3d_mesh_high_level",
                        payload={"build_3d_mesh_high_level": "completed"}
                    )
        ...
        error_payload = {
            ...
            "taskName": "build_3d_mesh_high_level",
            "errorMessage": str(e),
            "projectInfo": {
        ...
        task_instance.xcom_push(key="build_3d_mesh_high_level", value=error_payload)
        raise e
